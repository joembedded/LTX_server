 ...
 * (recommended 1-12 call(s) per day) as URL-fetch or as Script.
 * If called as Script, no URL parameter/$_SERVER[] available. 
 * (Script Command e.g.: '/bin/php ./WordPress_SecureMode_04/ltx/sw/lxs_obc_v1.php' (Output: 'none'))
 * ------------------------------------------------------
 *
 * Service-Functions - WORK
 * OPt. Call with k=Legcay-Key via URL
 * - Checks Ref. Integrity of Database
 *
 * Help: 
 * CMD: mysql -uroot   -> use DBNAME ->
 * SHOW TABLES;
 *
 * Notes:
 ...
 * Service can be started manually extern (as URL), see "@_GET[].."
...
if (!isset($_SERVER['SERVER_NAME'])) {
	...
	$_SERVER['PHP_SELF'] = "/ltx/sw/service/service.php";
